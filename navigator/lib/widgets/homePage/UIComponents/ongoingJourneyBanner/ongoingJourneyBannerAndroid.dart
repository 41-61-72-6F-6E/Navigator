  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        if (!afterArrival) {
          if (jrn.ongoingJourney!.journey.legs[leg].isWalking == true) {
            situationUpperBox = 2;
            situationLowerBox =
                leg == jrn.ongoingJourney!.journey.legs.length - 1 ? 3 : 0;
          } else {
            situationUpperBox = 1;
            situationLowerBox = 1;
          }
        } else {
          if (leg == jrn.ongoingJourney!.journey.legs.length - 1) {
            situationUpperBox = 0;
            situationLowerBox = 3;
          } else {
            situationUpperBox = 0;
            ...
            while (nextActualLegIndex <
                jrn.ongoingJourney!.journey.legs.length) {
              final nextLeg =
                  jrn.ongoingJourney!.journey.legs[nextActualLegIndex];
            ...
            if (nextActualLegIndex <
                jrn.ongoingJourney!.journey.legs.length) {
              final currentLegObj =
                  jrn.ongoingJourney!.journey.legs[leg];
              final nextLeg =
                  jrn.ongoingJourney!.journey.legs[nextActualLegIndex];
              ...
              if (nextActualLegIndex - leg > 1) {
                for (int interchangeIndex = leg + 1;
                  ...
                  final interchangeLeg =
                      jrn.ongoingJourney!.journey.legs[interchangeIndex];
              ...
              if (currentLegObj.destination.ril100Ids.isNotEmpty &&
                  nextLeg.origin.ril100Ids.isNotEmpty &&
                  widget.model.haveSameRil100Station(
                      currentLegObj.destination.ril100Ids,
                      nextLeg.origin.ril100Ids)) {
                isWalkingInterchange = true;
              }

              situationLowerBox = nextLeg.isWalking == true ? 2 : 0;
            } else {
              situationLowerBox = 3;
            }
          }
                ...
                child: Column(
                  children: [
                    ...
                    OngoingJourneyUpperBoxAndroid(
                        model: widget.model,
                        leg: leg,
                        situation: situationUpperBox),
                    const SizedBox(height: 8),
                    OngoingJourneyLowerBoxAndroid(
                        model: widget.model,
                        leg: leg,
                        situation: situationLowerBox),
                  ],
                ),
              ),
            ),
...
class OngoingJourneyUpperBoxAndroid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (situation) {
            ...
            child: Column(
              children: [
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    jrn.ongoingJourney!.journey.legs[leg].destination.name,
      ...
      case 1:
        Color lineColor =
            jrn.ongoingJourney!.journey.legs[leg].lineColorNotifier.value ??
                Colors.grey;
        Color onLineColor =
        ...
        Trip? t = jrn.legIndexToTripMap[leg];
        ...
        if (t != null && t.stopovers.isNotEmpty) {
          for (Stopover s in t.stopovers) {
            ...
            DateTime legArrival =
                jrn.ongoingJourney!.journey.legs[leg].arrivalDateTime;
            if (arrivalTime != null) {
            ...
            child: Column(
              ...
              children: [
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    'on the ${jrn.ongoingJourney!.journey.legs[leg].product}',
                ...
                Row(
                  children: [
                    if (jrn.ongoingJourney!.journey.legs[leg].lineName != null)
                      Container(
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(24),
                          color: lineColor,
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            jrn.ongoingJourney!.journey.legs[leg].lineName!,
                            style: texts.labelMedium!
                                .copyWith(color: onLineColor),
                          ),
                        ),
                      ),
                    if (jrn.ongoingJourney!.journey.legs[leg].direction != null)
                      const SizedBox(width: 8),
                    if (jrn.ongoingJourney!.journey.legs[leg].direction != null)
                      Text(
                        jrn.ongoingJourney!.journey.legs[leg].direction!,
            ...
            child: Column(
              ...
              children: [
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    'Walk ${jrn.ongoingJourney!.journey.legs[leg].distance}m'
                    ' (${jrn.ongoingJourney!.journey.legs[leg].arrivalDateTime.difference(jrn.ongoingJourney!.journey.legs[leg].departureDateTime).inMinutes} minutes) towards',
                    style: texts.bodyMedium!.copyWith(color: colors.onPrimary),
                  ),
                ),
                const SizedBox(height: 4),
...
class IntermediateStopsExpanderAndroid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      listenable: model.journey,
      builder: (context, _) {
        final colors = Theme.of(context).colorScheme;
        final texts = Theme.of(context).textTheme;
        final expanded = model.journey.intermediateStopsExpanded;
...
class OngoingJourneyLowerBoxAndroid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (situation) {
      case 0:
        Color lineColor = jrn.ongoingJourney!.journey.legs[leg + 1]
        ...
        return Container(
          decoration: BoxDecoration(
            color: colors.primaryContainer,
            borderRadius: jrn.lowerBoxExpanded
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Take the ${jrn.ongoingJourney!.journey.legs[leg + 1].product}',
                            style: texts.bodyMedium!
                                .copyWith(color: colors.onPrimaryContainer),
                          ...
                          Row(
                            children: [
                              if (jrn.ongoingJourney!.journey.legs[leg + 1]
                                      .lineName !=
                                  null)
                                Container(
                                  decoration: BoxDecoration(
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            Text(
                              model.prettyPrintTime(jrn.ongoingJourney!
                            ...
                            if (jrn.ongoingJourney!.journey.legs[leg + 1]
                                ...
                                null)
                              Text(
                                'Platform ${jrn.ongoingJourney!.journey.legs[leg + 1].arrivalPlatform!}',
                ...
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          'Get off in ${jrn.ongoingJourney!.journey.legs[leg].arrivalDateTime.difference(DateTime.now()).inMinutes} minutes'
                          '(${stopsBeforeInterchange.length + 1} stops) at',
                          style: texts.bodyMedium!
                              .copyWith(color: colors.onPrimaryContainer),
                        ),
                        const SizedBox(height: 4),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            if (jrn.ongoingJourney!.journey.legs[leg]
                                    .arrivalPlatform !=
                                null)
                              Text(
                                'Platform ${jrn.ongoingJourney!.journey.legs[leg].arrivalPlatform!}',
                                style: texts.bodyMedium!.copyWith(
                                    color: colors.onTertiaryContainer),
                              ),
                          ],
            ...
            child: Column(
              ...
              children: [
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    'Walk ${jrn.ongoingJourney!.journey.legs[leg + 1].distance}m'
                    ' (${jrn.ongoingJourney!.journey.legs[leg + 1].arrivalDateTime.difference(jrn.ongoingJourney!.journey.legs[leg + 1].departureDateTime).inMinutes} minutes) towards',
                    style: texts.bodyMedium!
                        .copyWith(color: colors.onPrimaryContainer),
                  ),
                ),
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    jrn.ongoingJourney!.journey.legs[leg + 1].destination.name,
                    style: texts.titleLarge!
                        .copyWith(color: colors.onPrimaryContainer),
                  ),
                ),
                FilledButton.icon(
                  ...
                  onPressed: () => model.focusMapOnLeg(
                      jrn.ongoingJourney!.journey.legs[leg + 1]),
                  label: Text('Focus on Map',
                      style: texts.bodyMedium!
                          .copyWith(color: colors.onPrimary)),
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Arrive in ${jrn.ongoingJourney!.journey.legs[leg].arrivalDateTime.difference(DateTime.now()).inMinutes} minutes at',
                                style: texts.bodyMedium!.copyWith(
                                    color: colors.onPrimaryContainer),
                              ),
                              const SizedBox(height: 4),
